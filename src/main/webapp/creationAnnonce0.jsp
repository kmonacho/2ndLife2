...
<fieldset>
                ...
                <p> Vueillez d'abord choisir les images que vous souhaitez joindre à votre annonce, puis remplir les différentes informations sur l'annonce (titre, description, prix, ...).
</p>
