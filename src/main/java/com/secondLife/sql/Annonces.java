...
public class Annonces {
	...
	public Annonces(String nomDB, String nomDossierDB, String passwordDB) {
		conString += nomDB;
						...
						while(rs.next()) {
							...
							while (it.hasNext()){
								if (search(titre, description, vendeur, prix, dateMEV, it.next())) {
									annonces.add(annonce);
									System.out.println("id de l'annonce dont le titre, la description,le prix, ou la dateMEV correspond avec le mot clé => id : "+id);
								}
							}							
						}
			}
